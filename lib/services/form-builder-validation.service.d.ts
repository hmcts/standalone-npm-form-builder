...
import { controlsisTextAreaValidWhenCheckboxChecked } from './form-group-validation.typescript';
export declare class ValidationService {
     ...
     * // @returnArray
     */
    getNgValidationFunctionMap(): any[];
    /**
    ...
    isAllFieldsRequiredValidationFn(controls: FormGroup, fields: Array<string>, validationIdentifier: any): {
        [x: number]: boolean;
    };
    /**
     * isAllFieldsRequired
     ...
     *
     */
    isValidDateValidationFn(controls: FormGroup, fields: Array<string>, validationIdentifier: any): {
        [x: number]: boolean;
    };
     ...
     * //@return {any}
     */
    isTextAreaValidWhenCheckboxChecked(formGroup: FormGroup, controls: controlsisTextAreaValidWhenCheckboxChecked, validationIdentifier: string): ValidatorFn;
    /**
     ...
     * // @return {any}
     */
    isRadioValidWhenSomeOptionSelected(formGroup: FormGroup, controls: any, validationIdentifier: string): ValidatorFn;
    /**
     ...
     * // @param formGroupValidators - [{
       ...
       *    ]}]
     */
    createFormGroupValidators(formGroup: FormGroup, formGroupValidators: any): any;
    /**
